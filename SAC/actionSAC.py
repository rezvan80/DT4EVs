...
from SAC.model import GaussianPolicy_ActionGNN, Critic_GNN
...
class SAC_ActionGNN(object):
    ...
    def __init__(self,
        ...
        self.actor_num_gcn_layers = args['actor_num_gcn_layers']
        self.critic_num_gcn_layers = args['critic_num_gcn_layers']
        ...
        self.critic = Critic_GNN(feature_dim=args['fx_dim'],
                                 ...
                                 num_gcn_layers=self.critic_num_gcn_layers,
        ...
        if self.policy_type == "Gaussian":
            ...
            self.policy = GaussianPolicy_ActionGNN(action_space=action_space,
                                                   ...
                                                   GNN_hidden_dim=args['fx_GNN_hidden_dim'],
                                                   num_gcn_layers=self.actor_num_gcn_layers,
    ...
    def special_load(self, state_dict, evaluate=False):
