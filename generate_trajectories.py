...
if __name__ == "__main__":
    ...
    trajecotries_type = "RR" #args.dataset

    file_name = f"{problem}_{trajecotries_type}_{reward_function.__name__}_{number_of_charging_stations}_cs_{n_transformers}_tr_{steps}_steps_{timescale}_timescale_{n_trajectories}.pkl"
